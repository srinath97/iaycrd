            ...
            <div class="container-fluid">
				...
				if(isset($_POST['submit']))
				{
                   ...
                   echo "<h2>Displaying data for ".$_POST['district']."</h2>";
				    $query="SELECT id FROM survey WHERE id='1' && district='$district'";
					$result=mysqli_query($stat,$query);
					$flag1=1;
				    ...
				    $query="SELECT id FROM survey WHERE id='2' && district='$district'";
					$result=mysqli_query($stat,$query);
			        $flag=1;
			        $id=2;
					if(mysqli_num_rows($result)==0)
	                ...
	                $query="SELECT SUM(completed) AS completed FROM survey WHERE id='$id' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					$completed=$row['completed'];
					
					$district=$_POST['district'];
				    $query="SELECT SUM(plinth) AS plinth_level FROM survey WHERE id='$id' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					$plinth=$row['plinth_level'];
					
					$query="SELECT SUM(lintel) AS lintel_level FROM survey WHERE id='$id' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					$lintel=$row['lintel_level'];
					
					$query="SELECT SUM(roof) AS roof_level FROM survey WHERE id='$id' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					$roof=$row['roof_level'];
					
					$query="SELECT SUM(cancelled) AS cancelled FROM survey WHERE id='$id' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					$cancelled=$row['cancelled'];
					
					$query="SELECT SUM(pending) AS pending FROM survey WHERE id='$id' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					$pending=$row['pending'];
					}
					...
					{
				    $district=$_POST['district'];
				    $query="SELECT SUM(plinth) AS plinth_level FROM survey WHERE id='1' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					...
					$query="SELECT SUM(lintel) AS lintel_level FROM survey WHERE id='1' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					$lintel=$row['lintel_level']-$lintel;
					
					$query="SELECT SUM(roof) AS roof_level FROM survey WHERE id='1' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					$roof=$row['roof_level']-$roof;
					
					$query="SELECT SUM(cancelled) AS cancelled FROM survey WHERE id='1' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
					$cancelled=$row['cancelled']-$cancelled;
					
					$query="SELECT SUM(pending) AS pending FROM survey WHERE id='1' && district='$district'";
					$result=mysqli_query($stat,$query);
					$row=mysqli_fetch_array($result);
